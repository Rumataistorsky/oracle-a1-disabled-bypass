...
def cover(c):
    ...
    c.setFont('DJ', 8.5)
    for t in [
        'Зняти одометр в останній день податкового року — обовʼязково.',
        'Зберігати чеки: журнал доводить кілометри, чеки — вартість.',
        'Тест 90% для van обговорити з бухгалтером до 31.12.2026.',
    ]:
        c.drawString(right_x, ry, t)
        ry -= 12
