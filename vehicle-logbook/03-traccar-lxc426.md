...
### Визначення протоколу невідомого пристрою

Для тесту PlanetGPS (`02-hardware-selection.md`) відкрити діапазон портів
і дивитись, який декодер підхопить:

```bash
pct exec 426 -- tail -f /opt/traccar/logs/tracker-server.log
```

Найпоширеніші порти для китайських OBD-трекерів:

| Порт | Протокол |
|---|---|
| 5013 | gt06 (Concox / Jimi) |
| 5023 | h02 |
| 5001 | gps103 / tk103 |
| 5027 | teltonika |
| 5093 | queclink (gl200) |

У логах видно спробу підключення і те, чи декодер розпарсив пакет.
